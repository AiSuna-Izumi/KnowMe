...
export default class Dass2 extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            count: 0,
            question :3,
            soalan :"I couldn’t seem to experience any positive feeling at all",
            };
      ...
      onPressQuestion = () => {
        this.setState({
          ...
          soalan :"I experienced breathing difficulty (e.g. excessively rapid breathing,breathlessness in the absence of physical exertion)"
        });
      };
    ...
    return (
        ...
        <View style={styles.box1}>
            <Text style={styles.mental}>Question as {question}</Text>
        ...
        <TouchableOpacity style={styles.loginButton} onPress={() => this.props.navigation.navigate('Final')}>
                <Image style={styles.buttonPng} source={require('../../assets/UII/button.png')} />
                <Text style={styles.textLogin}>NEXT</Text>
        </TouchableOpacity> 
        <TouchableOpacity style={styles.loginButton1}  onPress={() => this.props.navigation.navigate('Dass')}>
                <Image style={styles.buttonPng} source={require('../../assets/UII/button.png')} />
